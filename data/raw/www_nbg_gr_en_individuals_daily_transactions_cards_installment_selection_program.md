...
[ Transactions ](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
[ Insure & Invest ](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
[ Lending ](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
[ Security & Information ](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
[ Other ](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
[](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
Search for[](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
[](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
[ Individuals ](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
[Go For More](https://www.nbg.gr/en/go4more)[NBG Group](https://www.nbg.gr/en/group)
[Digital Banking](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
[![NBG Logo](https://www.nbg.gr/-/jssmedia/nbgportal/src/en-logo-black.svg)![NBG Logo](https://www.nbg.gr/-/jssmedia/nbgportal/src/en-logo-black.svg)](https://www.nbg.gr/en/individuals)
Search for[](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
[](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)[hamburger-text](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
  * [Everyday needs](https://www.nbg.gr/en/individuals/daily-transactions)
[Everyday needs](https://www.nbg.gr/en/individuals/daily-transactions)
    * [Accounts](https://www.nbg.gr/en/individuals/daily-transactions/banking-accounts)
[Accounts](https://www.nbg.gr/en/individuals/daily-transactions/banking-accounts)
...
[Close Button](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
![Jumbo image background](https://www.nbg.gr/-/jssmedia/Images/idiwtes/kathimerines-sunallages/trapezikes-kartes/epilogh-se-doseis/2560600-1-flip.jpg?h=600&iar=0&w=2560&hash=B5AE1C8E154B46198AA922642546548C)
# Υπηρεσία Επιλογή σε Δόσεις
Γνωρίστε την υπηρεσία που μετατρέπει τις εφάπαξ συναλλαγές της χρεωστικής σας κάρτας, σε έως και 12 δόσεις στην πιστωτική σας κάρτα, μέσω Internet Βanking!
...
Η υπηρεσία “Επιλογή σε Δόσεις” σας προσφέρει τη δυνατότητα να μετατρέψετε μία εφάπαξ συναλλαγή που έχετε πραγματοποιήσει με τη χρεωστική σας κάρτα, μεταφέροντάς την στην πιστωτική, σε έως 12 δόσεις, απλά και γρήγορα, μέσω Internet Banking. Συνδεθείτε σήμερα στο Internet Banking της Εθνικής Τράπεζας και ανακαλύψτε πως μπορείτε να διαχειριστείτε τις συναλλαγές σας με ευέλικτο και απλό τρόπο.
Συγκεκριμένα μπορείτε να: 
  * Επιλέγετε συναλλαγές από τη χρεωστική σας κάρτα και να τις αποπληρώνετε σε δόσεις στην πιστωτική σας ανάλογα με τις ανάγκες σας
  * Αποκτήσετε ρευστότητα μεταφέροντας τη συναλλαγή σας από τη χρεωστική στην πιστωτική σας κάρτα με μερικά κλικ στο Internet Banking

  

## In brief:
  * Μετατροπή των εφάπαξ συναλλαγών της χρεωστικής σας κάρτας, σε έως και 12 δόσεις στην πιστωτική σας κάρτα
  * Άμεση ρευστότητα
  * Ευελιξία μέσω Internet Banking


[Επιλογή σε Δόσεις](https://ibank.nbg.gr/)
[I want to get in touch](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
## Τι προσφέρει η υπηρεσία Επιλογή σε Δόσεις 
### Ευελιξία Συναλλαγών
Μετατρέψτε τις συναλλαγές από 50€ έως 1.500€ που έχετε πραγματοποιήσει με τη χρεωστική σας κάρτα εντός των τελευταίων 30 ημερών σε έως 12 δόσεις στην πιστωτική σας. 
### Άμεση Διαδικασία 
Εύκολα και γρήγορα, με μερικά κλικ στο Internet Banking, επιλέγοντας τις συναλλαγές που θέλετε να μεταφέρετε.
### Ευκολία και Ασφάλεια
Παρακολουθήστε τις συναλλαγές σας και τις δόσεις σας με απόλυτη ασφάλεια μέσα από το περιβάλλον του Internet Banking της Εθνικής Τράπεζας.
## Η υπηρεσία Επιλογή σε Δόσεις αναλυτικά
Χαρακτηριστικά της υπηρεσίας Επιλογή σε δόσεις
  * Προσφέρει τη δυνατότητα να εξοφλήσετε τις εφάπαξ συναλλαγές της χρεωστικής σας κάρτας, μεταφέροντάς τες στην πιστωτική σας σε δόσεις, είτε πρόκειται για μεγαλύτερες συναλλαγές, είτε για μικρότερες καθημερινές δαπάνες.
  * Μετατρέπει εύκολα και γρήγορα κάθε εφάπαξ συναλλαγή ποσού από **50€** έως **1.500€** που έχει πραγματοποιηθεί εντός των τελευταίων 30 ημερών σε δόσεις, με μερικά κλικ στο Internet Banking.


Για ποιους είναι η υπηρεσία Επιλογή σε Δόσεις;
  * Για οικογένειες που χρειάζονται να διαχειριστούν μεγάλες αγορές.
  * Για επαγγελματίες που επιθυμούν να ελέγξουν καλύτερα τις επαγγελματικές τους δαπάνες.
  * Για όσους επιθυμούν να αποκτήσουν άμεση ρευστότητα.


Όροι Μεταφοράς και Επιμερισμού Συναλλαγής σε Δόσεις
Διαβάστε τους [Όρους Μεταφοράς και Επιμερισμού Συναλλαγής σε Δόσεις](https://www.nbg.gr/-/jssmedia/Files/Idiwtes/Kathimerines-sunallages/trapezikes-kartes/programma-epilogh-se-doseis/oroi-metaforas-kai-epimerismou-synallagis-se-doseis.pdf) για περισσότερες πληροφορίες σχετικά με την υπηρεσία.
Τιμολόγιο και Πληροφορίες
H υπηρεσία Επιλογή σε Δόσεις προσφέρει τη δυνατότητα μετατροπής των συναλλαγών σε έως 12 δόσεις με κόστος 2€/δόση και με ελάχιστο ποσό κάθε δόσης τα 10€. Το κόστος της υπηρεσίας διαμορφώνεται ανάλογα με τον επιλεγμένο αριθμό μηνιαίων δόσεων και χρεώνεται συνολικά στον συνδεδεμένο λογαριασμό της χρεωστικής σας κάρτας με την ολοκλήρωση της μετατροπής της συναλλαγής σε δόσεις. Για να μάθετε περισσότερα για το τιμολόγιο της υπηρεσίας Επιλογή σε Δόσεις, πατήστε [εδώ](https://www.nbg.gr/-/jssmedia/Files/Timologio/web_portal_elliniko_epitokia-timologio_kartwn.pdf). 
Μετά την μεταφορά/επιμερισμό μιας συναλλαγής σε δόσεις για την εξόφληση της εν λόγω οφειλής ισχύουν οι όροι χορήγησης και χρήσης της πιστωτικής σας κάρτας.
Απαιτούνται δικαιολογητικά για την χρήση της υπηρεσίας Επιλογή σε Δόσεις;
Όχι, δεν απαιτούνται δικαιολογητικά.
Δεν είμαι εγγεγραμμένος στο Internet Banking. Τι πρέπει να κάνω;
Αν δεν έχετε κωδικούς Internet Banking μπορείτε να αιτηθείτε την έκδοσή τους [εδώ](https://www.nbg.gr/en/individuals/daily-transactions/digital-banking/internet-mobile-banking-capabilities/register-for-digital-banking).
## Ενεργοποιήστε την υπηρεσία Επιλογή σε Δόσεις με 4 απλά βήματα
Συνδεθείτε στο Digital Banking
Συνδεθείτε στον λογαριασμό σας και μεταβείτε στην ενότητα Κάρτες. 
Επιλέξτε την υπηρεσία Επιλογή σε Δόσεις
Επιλέξτε την υπηρεσία Επιλογή σε Δόσεις, διαλέξτε την εφάπαξ συναλλαγή από τη χρεωστική σας κάρτα μεταφέροντάς τη στην πιστωτική, σε έως 12 δόσεις.
Καθορίστε τις δόσεις
Επιλέξτε τον αριθμό των δόσεων που επιθυμείτε, ανάλογα με τις ανάγκες σας.
Ολοκληρώστε τη διαδικασία
Επιβεβαιώστε την επιλογή σας και επωφεληθείτε από το νέο τρόπο πληρωμής στην πιστωτική σας κάρτα.
## You may also like 
...
![Debit Cards](https://www.nbg.gr/dist/nbgportal/browser/assets/images/default-image.png)
### Debit cards
Make your everyday life easier through secure transactions
[Tell me more](https://www.nbg.gr/en/individuals/daily-transactions/cards/debit-cards "Tell me more")
![Credit Cards](https://www.nbg.gr/dist/nbgportal/browser/assets/images/default-image.png)
### Credit cards
Choose the one that best fits your needs and receive lower interest rates 
[Tell me more](https://www.nbg.gr/en/individuals/daily-transactions/cards/credit-cards "Tell me more")
![Mastercard Credit](https://www.nbg.gr/dist/nbgportal/browser/assets/images/default-image.png)
### Mastercard Credit
Enjoy absolute freedom of movement in your everyday shopping.
[Tell me more](https://www.nbg.gr/en/individuals/daily-transactions/cards/credit-cards/mastercard "Tell me more")
...
[ I want help ](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
[I want information](https://www.nbg.gr/en/footer/contact-us)
[ I want help ](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
...
[back-to-top](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
![Logo](https://www.nbg.gr/dist/nbgportal/browser/assets/images/default-image.png)
Πώς μπορώ να βοηθήσω;
![Chat](https://www.nbg.gr/en/individuals/daily-transactions/cards/installment-selection-program)
